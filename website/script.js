document.addEventListener('DOMContentLoaded', () => {
  ...
  if (os === 'Windows') {
    ...
    versionInfo.textContent = 'Version 1.2.4 • Windows 10/11';
    downloadBtn.href = 'https://github.com/skjoel225/skj-ide/releases/download/v1.2.4/SKJ-IDE-Setup-1.2.4.exe';
  } else {
    downloadBtn.querySelector('.text').textContent = `Télécharger pour Windows`;
    versionInfo.textContent = `Version 1.2.4 • Vous semblez être sur ${os}, mais seul Windows est supporté pour le moment.`;
    downloadBtn.href = 'https://github.com/skjoel225/skj-ide/releases/download/v1.2.4/SKJ-IDE-Setup-1.2.4.exe';
  }
